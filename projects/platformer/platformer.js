...
createCollectable('max',680,0)
createCollectable('max',777,0)
...
createCannon("right",390,1650,40,40)
createCannon("left",90,1650,40,40)
createCannon("left",660,1650,40,40)
